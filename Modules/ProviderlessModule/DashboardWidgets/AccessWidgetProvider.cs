...
namespace ProviderlessModule.DashboardWidgets;

public class AccessWidgetProvider : WidgetProviderAbstract
{
    ...
    public AccessWidgetProvider(IServiceProvider serviceProvider, IDashboardSessionManager sessionManager)
